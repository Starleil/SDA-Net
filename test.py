...
def arg_parse():
    ...
    parser.add_argument('-w', '--weight', default='checkpoints/your_path_to_pth',
...
def main():
    ...
    print('Resuming network: {}'.format(args.weight))
    load_checkpoint(BasicModel, args.weight)
    ...
    test_loader = net_utils.prepare_net(config, BasicModel, 'test')

    net_utils.test_net(test_loader, BasicModel, config, args)
